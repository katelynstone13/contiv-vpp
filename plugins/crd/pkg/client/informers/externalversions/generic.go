...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=bgpconfig.contiv.vpp, Version=v1
	case v1.SchemeGroupVersion.WithResource("bgpconfigs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Bgpconfig().V1().BgpConfigs().Informer()}, nil
